...
class my_class:
    def __init__(self):
        ...
        self.odom_sub = rospy.Subscriber("/RosAria/pose", Odometry, self.odom_callback)
        # self.visual_odom_sub = rospy.Subscriber("/rtabmap/odom", Odometry, self.odom_callback)
        # self.amcl_sub = rospy.Subscriber("/amcl_pose", PoseWithCovarianceStamped, self.odom_callback)
